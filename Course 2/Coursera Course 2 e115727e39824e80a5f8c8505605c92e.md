...
Covariate Shift - If  model has learned some X to Y mapping and distribution oif X changes, then the model needs to be retrained. This is true even if the ground true function whcih maps X to Y remains unchanged. 
